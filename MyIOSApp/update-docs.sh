...
update_project_structure() {
    ...
    if command -v tree &> /dev/null; then
        tree -I 'node_modules|.git|.expo' > docs/generated/current_structure.txt
    else
        # Fallback to find command
        find . -type d -name "node_modules" -prune -o -name ".git" -prune -o -name ".expo" -prune -o -type f -print | head -50 > docs/generated/current_structure.txt
    fi
...
update_performance_metrics() {
    ...
    echo "Run 'npx expo export --clear' manually for detailed analysis" >> docs/generated/bundle_analysis.txt
